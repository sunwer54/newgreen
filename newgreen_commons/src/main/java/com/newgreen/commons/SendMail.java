...
public class SendMail {
	// 发件人邮箱地址
	private static String from = "752494484@qq.com";
// 发件人称号，同邮箱地址
	private static String user = "752494484@qq.com";
// 发件人邮箱客户端授权码
	private static String password = "wmfqxwexxizqbebj";
//发件人的邮箱服务器
...
// 把邮件发送出去
	...
	public static void main(String[] args) { // 做测试用
		...
		String toMail = "229497488@qq.com";
		String text = "你好,您的易购订单已经在向你奔来,敬请等待收货!";
